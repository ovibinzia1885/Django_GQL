...
class MovieType(DjangoObjectType):
    ...
    def resolve_movie_age(self, info):
        ...
        return "old movie" if self.year <2000 else "newmovie"
...
class Query(graphene.ObjectType):
    ...
    # movies=graphene.List(MovieType,id=graphene.Int(),title=graphene.String())
    ...
    #     #     raise Exception('Auth credentials were not provied')
    #
...
class Mutation:
    ...
    verfiy_token=graphql_jwt.Verify.Field( )
